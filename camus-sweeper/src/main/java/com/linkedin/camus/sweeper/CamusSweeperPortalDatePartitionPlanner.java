...
public class CamusSweeperPortalDatePartitionPlanner extends CamusSweeperPlanner
{
  ...
  {  
    ...
    if (props.containsKey("camus.sweeper.planner.portals")) {
        portals = props.getProperty("camus.sweeper.planner.portals").split(",");
    } else {
        throw new IOException("Please specify comma separated list of portals in: camus.sweeper.planner.portals");
    }
    ...
    for (int i = 0; i < numDays; ++i)
    {
      ...
      for (String portal : portals) {
	      ...
	      String directory = "portal=" + portal + "/" + dayFormatter.print(currentDate);
